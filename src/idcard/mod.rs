...
//! Chinese identity card utilities vendored into `wp-lang`.
...
static CHINESE_ZODIAC: [&str; 12] = [
    "猪", "鼠", "牛", "虎", "兔", "龙", "蛇", "马", "羊", "猴", "鸡", "狗",
];

static CELESTIAL_STEM: [&str; 10] = ["癸", "甲", "乙", "丙", "丁", "戊", "己", "庚", "辛", "任"];

static TERRESTRIAL_BRANCH: [&str; 12] = [
    "亥", "子", "丑", "寅", "卯", "辰", "巳", "午", "未", "申", "酉", "戌",
];

static PROVINCE_CODE_NAME: LazyLock<HashMap<&'static str, &'static str>> = LazyLock::new(|| {
