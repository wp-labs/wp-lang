...
static PREFIX_LETTERS: LazyLock<HashMap<&'static str, (u32, &'static str)>> = LazyLock::new(|| {
...
static PATTERN: LazyLock<Regex> = LazyLock::new(|| Regex::new(r"^[a-zA-Z][0-9]{9}$").unwrap());
